/* eslint-disable */
// note to self: when replacing luxon.js with an updated version, remove the end comment along the lines of //# sourceMappingURL=luxon.js.map
/*
Some Luxon examples
This is not meant to be a comprehensive showcase of Luxon's capabilities, just a quick flavoring.
see also formatting: https://moment.github.io/luxon/#/formatting

Info.features()	//=>	{"relative":true}
DateTime.now()	//=>	[ DateTime 2021-09-08T08:16:09.943-07:00 ]
...
DateTime.now().toUTC()	//=>	[ DateTime 2021-09-08T15:16:09.954Z ]
DateTime.utc(2017, 5, 15, 17, 36).toLocal()	//=>	[ DateTime 2017-05-15T10:36:00.000-07:00 ]
DateTime.now().toObject()	//=>	{"year":2021,"month":9,"day":8,"hour":8,"minute":16,"second":9,"millisecond":955}
...
DateTime.now().plus({minutes: 15, seconds: 8})	//=>	[ DateTime 2021-09-08T08:31:17.958-07:00 ]
DateTime.now().plus({days: 6})	//=>	[ DateTime 2021-09-14T08:16:09.959-07:00 ]
DateTime.now().minus({days: 6})	//=>	[ DateTime 2021-09-02T08:16:09.959-07:00 ]
DateTime.now().diff(DateTime.local(1982, 5, 25)).milliseconds	//=>	1239956169960
DateTime.now().diff(DateTime.local(1982, 5, 25), 'days').days	//=>	14351.344559722222
DateTime.now().diff(DateTime.local(1982, 5, 25), ['days', 'hours'])	//=>	[ Duration {"days":14351,"hours":8.269433611111111} ]
DateTime.now().toLocaleString()	//=>	"9/8/2021"
DateTime.now().setLocale('zh').toLocaleString()	//=>	"2021/9/8"
DateTime.now().toLocaleString(DateTime.DATE_MED)	//=>	"Sep 8, 2021"
DateTime.now().setLocale('zh').toLocaleString(DateTime.DATE_MED)	//=>	"2021年9月8日"
DateTime.now().setLocale('fr').toLocaleString(DateTime.DATE_FULL)	//=>	"8 septembre 2021"
...
DateTime.now().toFormat('MM-dd-yyyy')	//=>	"09-08-2021"
DateTime.now().toFormat('MMMM dd, yyyy')	//=>	"September 08, 2021"
DateTime.now().setLocale('fr').toFormat('MMMM dd, yyyy')	//=>	"septembre 08, 2021"
